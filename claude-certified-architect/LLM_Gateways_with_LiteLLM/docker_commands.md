...
words. Meant to be followed top to bottom (or copy-pasted as a script).
...
# IMPORTANT for this project specifically: also edit PROXY_URL in
# .env.docker to http://host.docker.internal:4000 - "localhost" means
# the container itself, not your host machine where the proxy runs.
...
# ============================================================
docker run -d --name my-app -p 8501:8501 --env-file .env.docker my-app
...
docker tag my-app jeevan535510/my-app:latest

# actually upload it
docker push jeevan535510/my-app:latest
...
# ============================================================
docker rmi jeevan535510/my-app:latest

# confirm the Docker Hub tag is gone (the original "my-app"
...
# ============================================================
docker pull jeevan535510/my-app:latest
docker images

# run the pulled copy on a different port, to prove it's the same app
docker run -d --name my-app-from-hub -p 8502:8501 --env-file .env.docker jeevan535510/my-app:latest
docker ps
...
# ============================================================
docker stop my-app my-app-from-hub
docker rm my-app my-app-from-hub
docker rmi my-app jeevan535510/my-app:latest
docker logout
